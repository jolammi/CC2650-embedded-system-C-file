...
Note that to get the code work properly, you would need a lot more files incuding for example the functions for the temperature sensor, gyrosensor and wireless transfering. A person capable of reading C language will get the main idea of the code.
